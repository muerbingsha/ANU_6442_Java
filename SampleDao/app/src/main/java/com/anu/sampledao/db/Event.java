...
//    public int id;
    ...
    // 1) After change this, I can modify the title
    // so I set eid as primary key
    // 2) But I will use title.hashCode as notification id
    // so i change primary key back to title
//    @ColumnInfo(name = "eid")
//    public int id;
